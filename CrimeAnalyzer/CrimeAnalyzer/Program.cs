...
namespace CrimeAnalyzer
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("File can not open!");
            }
            ...
            try
            {
                ...
                using (StreamWriter write = new StreamWriter("CrimeAnalyzerReport.txt"))
                {
                    ...
                    write.WriteLine($"{years.First()}-{years.Last()} {(i)}");
                    ...
                    write.Write("Minmum thefts per year (1999-2004): ");
                    ...
                    write.Write("Maxmum thefts per year (1999-2004): ");
                    ...
                    write.Write("Years of highest number of motor vechicle thefts: ");
                   
                    write.WriteLine(highestvechicle.Last());

                    write.Close();
                }
                Console.WriteLine("Crime Analyzer Report file has be created!");
            }

            catch (Exception ex)
            {
                Console.WriteLine("File did not write!");
            }
            Console.ReadLine();        
        }
    }
